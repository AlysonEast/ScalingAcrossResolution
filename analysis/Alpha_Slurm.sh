#!/bin/bash
#SBATCH --job-name=CrownsAlpha_wein
#SBATCH --time=10:00:00 #
#SBATCH --mail-type=ALL
#SBATCH --output=./outfiles/out_w%A_%a.out
...
Rscript RecoverAlphaParallel_weinstein.R $SLURM_ARRAY_TASK_ID 50 $SLURM_CPUS_PER_TASK
